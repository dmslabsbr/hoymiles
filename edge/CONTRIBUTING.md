...
Welcome to `hoymiles` contributor's guide.
...
If you experience bugs or general issues with `hoymiles`, please have a look
...
You can help improve `hoymiles` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`hoymiles` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `hoymiles`'s files. While this mechanism can
...
```
conda create -n hoymiles python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/hoymiles.git
   cd hoymiles
   ```
...
5. Install [pre-commit]:
   ...
   `hoymiles` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/hoymiles
[issue tracker]: https://github.com/<USERNAME>/hoymiles/issues
